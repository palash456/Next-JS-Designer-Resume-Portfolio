              ...
              <div className="art-banner-overlay">
                ...
                <div className="art-banner-title">
                  ...
                  <div className="art-lg-text art-code mb-25">
                    <span
                      dangerouslySetInnerHTML={{ __html: Data.subtitle.start }}
                    />
                    <span
                    ...
                    />
                    <span
                      dangerouslySetInnerHTML={{ __html: Data.subtitle.end }}
                    />
                  </div>

                  <a
  href="/img/akamshmohanCV.png"
  download="akamshmohanCV.png"
